...
def start_main_py_and_getPID(main_py_path):
    if main_py_path:
        ...
        # 启动 main.py 脚本
        process = subprocess.Popen(['python3', main_py_path, "--mode", "default"], cwd=working_dir)  # 运行 main.py 脚本
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", choices=["preliminary", "final"], required=True, help="Specify the mode to run: 'preliminary' or 'final'")
