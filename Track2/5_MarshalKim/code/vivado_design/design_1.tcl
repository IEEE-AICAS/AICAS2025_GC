...
\
    ...
    CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {333.329987} \
...
\
  ...
  # Create instance: QWEN_0, and set properties
  set QWEN_0 [ create_bd_cell -type ip -vlnv user.org:user:QWEN:1.0 QWEN_0 ]
  ...
  connect_bd_intf_net -intf_net QWEN_0_gmem1 [get_bd_intf_pins QWEN_0/gmem1] [get_bd_intf_pins smartconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net QWEN_0_gmem2 [get_bd_intf_pins QWEN_0/gmem2] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP3_FPD]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins QWEN_0/axilite]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins QWEN_0/resetn] [get_bd_pins smartconnect_1/aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins QWEN_0/clk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs QWEN_0/axilite/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces QWEN_0/gmem1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces QWEN_0/gmem2] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_LOW] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces QWEN_0/gmem1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces QWEN_0/gmem1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces QWEN_0/gmem1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces QWEN_0/gmem2] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces QWEN_0/gmem2] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_LPS_OCM]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces QWEN_0/gmem2] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_QSPI]
