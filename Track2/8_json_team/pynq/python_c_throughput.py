# this throughput is modified by Chinese DALISHI Group for our FPGA
# we execute the model twice to imitate the PREFILL and kvcache and DECODE part.(for we only support len > 192)
...
import json
import argparse
from runFPGA import runInfer, runThroughput
