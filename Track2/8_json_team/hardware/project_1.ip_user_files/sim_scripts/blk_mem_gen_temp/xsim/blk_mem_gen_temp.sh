...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_temp xil_defaultlib.blk_mem_gen_temp xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_temp -key {Behavioral:sim_1:Functional:blk_mem_gen_temp} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_44e3.protoinst" -protoinst "protoinst_files/bd_2721.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blk_mem_gen_temp.wdb xsim.dir libdpi.so)
