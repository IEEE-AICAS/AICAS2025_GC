...
#
# Script generated by Vivado on Fri Feb 14 21:08:03 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blk_mem_gen_temp.sh
...
#
# Usage        : blk_mem_gen_temp.sh
#                blk_mem_gen_temp.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_gen_temp.sh [-reset_run]
#                blk_mem_gen_temp.sh [-reset_log]
#                blk_mem_gen_temp.sh [-help]
#
...
#                script (type 'blk_mem_gen_temp.sh -help' for more information).
#
...
# script info
echo -e "blk_mem_gen_temp.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_gen_temp.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.blk_mem_gen_temp xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.blk_mem_gen_temp -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log blk_mem_gen_temp_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blk_mem_gen_temp.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blk_mem_gen_temp.sh [-help]\n\
Usage: blk_mem_gen_temp.sh [-step]\n\
Usage: blk_mem_gen_temp.sh [-lib_map_path]\n\
Usage: blk_mem_gen_temp.sh [-reset_run]\n\
Usage: blk_mem_gen_temp.sh [-reset_log]\n\
Usage: blk_mem_gen_temp.sh [-keep_index]\n\
Usage: blk_mem_gen_temp.sh [-noclean_files]\n\n\
