...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_dsp48_wrapper_v3_0_6 -L xbip_utils_v3_0_14 -L xbip_pipe_v3_0_10 -L dsp_macro_v1_0_7 -L xilinx_vip -L secureip -L xpm --snapshot dsp_macro_bypass xil_defaultlib.dsp_macro_bypass -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dsp_macro_bypass -key {Behavioral:sim_1:Functional:dsp_macro_bypass} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_44e3.protoinst" -protoinst "protoinst_files/bd_2721.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dsp_macro_bypass.wdb xsim.dir libdpi.so)
