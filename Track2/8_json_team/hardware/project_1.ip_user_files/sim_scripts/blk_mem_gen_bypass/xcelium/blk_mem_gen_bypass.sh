...
#
# Script generated by Vivado on Sun Feb 16 17:57:23 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blk_mem_gen_bypass.sh
...
#
# Usage        : blk_mem_gen_bypass.sh
#                blk_mem_gen_bypass.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_gen_bypass.sh [-reset_run]
#                blk_mem_gen_bypass.sh [-reset_log]
#                blk_mem_gen_bypass.sh [-help]
#
...
#                script (type 'blk_mem_gen_bypass.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname blk_mem_gen_v8_4_9 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm blk_mem_gen_v8_4_9 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "blk_mem_gen_bypass.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_gen_bypass.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"/home/adnepukan/vitis/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"/home/adnepukan/vitis/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_9 $xmvlog_opts +incdir+"/home/adnepukan/vitis/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"/home/adnepukan/vitis/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.blk_mem_gen_bypass xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.blk_mem_gen_bypass -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log blk_mem_gen_bypass_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blk_mem_gen_bypass.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blk_mem_gen_bypass.sh [-help]\n\
Usage: blk_mem_gen_bypass.sh [-step]\n\
Usage: blk_mem_gen_bypass.sh [-lib_map_path]\n\
Usage: blk_mem_gen_bypass.sh [-reset_run]\n\
Usage: blk_mem_gen_bypass.sh [-reset_log]\n\
Usage: blk_mem_gen_bypass.sh [-keep_index]\n\
Usage: blk_mem_gen_bypass.sh [-noclean_files]\n\n\
