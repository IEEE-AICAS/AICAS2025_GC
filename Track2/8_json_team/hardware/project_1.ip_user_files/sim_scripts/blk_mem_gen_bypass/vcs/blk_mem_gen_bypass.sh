...
design_libs=(xilinx_vip xpm blk_mem_gen_v8_4_9 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/home/adnepukan/vitis/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/home/adnepukan/vitis/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_9 $vlogan_opts +v2k +incdir+"/home/adnepukan/vitis/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/home/adnepukan/vitis/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.blk_mem_gen_bypass xil_defaultlib.glbl -o blk_mem_gen_bypass_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./blk_mem_gen_bypass_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key blk_mem_gen_bypass_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc blk_mem_gen_bypass_simv.daidir vcs_lib c.obj)
