...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dsp_macro_exp_silu xil_defaultlib.glbl -o dsp_macro_exp_silu_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dsp_macro_exp_silu_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dsp_macro_exp_silu_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dsp_macro_exp_silu_simv.daidir vcs_lib c.obj)
