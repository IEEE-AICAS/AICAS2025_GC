...
set psu_mio_init_data {
    ...
    mask_write 0XFF1800D0 0x000000FE 0x000000C0
    ...
    mask_write 0XFF1800D4 0x000000FE 0x000000C0
    ...
    mask_write 0XFF180208 0x003FFFFF 0x00200000
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF180320 0x33843384 0x02840284
		# : SD0 BASE CLOCK
