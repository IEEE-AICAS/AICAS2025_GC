...
entity Macro_MAC_Acc4_top_fifo_w32_d2_S_x is 
    generic (
...
architecture rtl of Macro_MAC_Acc4_top_fifo_w32_d2_S_x is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component Macro_MAC_Acc4_top_fifo_w32_d2_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_Macro_MAC_Acc4_top_fifo_w32_d2_S_x_ShiftReg : Macro_MAC_Acc4_top_fifo_w32_d2_S_x_ShiftReg
    generic map (
...
entity Macro_MAC_Acc4_top_fifo_w32_d2_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end Macro_MAC_Acc4_top_fifo_w32_d2_S_x_ShiftReg;

architecture rtl of Macro_MAC_Acc4_top_fifo_w32_d2_S_x_ShiftReg is
