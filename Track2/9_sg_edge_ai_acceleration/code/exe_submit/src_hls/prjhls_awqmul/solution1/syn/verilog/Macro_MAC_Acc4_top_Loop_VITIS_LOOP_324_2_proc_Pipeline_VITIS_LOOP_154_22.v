...
module Macro_MAC_Acc4_top_Loop_VITIS_LOOP_324_2_proc_Pipeline_VITIS_LOOP_154_22 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ap_idle,
        ap_ready,
        mro1_s_M_elems_V_0_din,
        mro1_s_M_elems_V_0_full_n,
        mro1_s_M_elems_V_0_write,
        mro1_s_M_elems_V_4_din,
        mro1_s_M_elems_V_4_full_n,
        mro1_s_M_elems_V_4_write,
        mro1_s_M_elems_V_1_din,
        mro1_s_M_elems_V_1_full_n,
        mro1_s_M_elems_V_1_write,
        mro1_s_M_elems_V_5_din,
        mro1_s_M_elems_V_5_full_n,
        mro1_s_M_elems_V_5_write,
        mro1_s_M_elems_V_2_din,
        mro1_s_M_elems_V_2_full_n,
        mro1_s_M_elems_V_2_write,
        mro1_s_M_elems_V_6_din,
        mro1_s_M_elems_V_6_full_n,
        mro1_s_M_elems_V_6_write,
        mro1_s_M_elems_V_7_din,
        mro1_s_M_elems_V_7_full_n,
        mro1_s_M_elems_V_7_write,
        mro1_s_M_elems_V_3_din,
        mro1_s_M_elems_V_3_full_n,
        mro1_s_M_elems_V_3_write,
        p_0_0_3721_partselect,
        p_0_0_2720_partselect,
        p_0_0_1719_partselect,
        empty
);
...
output   ap_idle;
output   ap_ready;
output  [31:0] mro1_s_M_elems_V_0_din;
input   mro1_s_M_elems_V_0_full_n;
output   mro1_s_M_elems_V_0_write;
output  [31:0] mro1_s_M_elems_V_4_din;
input   mro1_s_M_elems_V_4_full_n;
output   mro1_s_M_elems_V_4_write;
output  [31:0] mro1_s_M_elems_V_1_din;
input   mro1_s_M_elems_V_1_full_n;
output   mro1_s_M_elems_V_1_write;
output  [31:0] mro1_s_M_elems_V_5_din;
input   mro1_s_M_elems_V_5_full_n;
output   mro1_s_M_elems_V_5_write;
output  [31:0] mro1_s_M_elems_V_2_din;
input   mro1_s_M_elems_V_2_full_n;
output   mro1_s_M_elems_V_2_write;
output  [31:0] mro1_s_M_elems_V_6_din;
input   mro1_s_M_elems_V_6_full_n;
output   mro1_s_M_elems_V_6_write;
output  [31:0] mro1_s_M_elems_V_7_din;
input   mro1_s_M_elems_V_7_full_n;
output   mro1_s_M_elems_V_7_write;
output  [31:0] mro1_s_M_elems_V_3_din;
input   mro1_s_M_elems_V_3_full_n;
output   mro1_s_M_elems_V_3_write;
input  [31:0] p_0_0_3721_partselect;
input  [31:0] p_0_0_2720_partselect;
input  [31:0] p_0_0_1719_partselect;
input  [31:0] empty;
...
reg    ap_ready_int;
reg    mro1_s_M_elems_V_3_blk_n;
wire    ap_block_pp0_stage0_grp7;
reg    mro1_s_M_elems_V_2_blk_n;
wire    ap_block_pp0_stage0_grp5;
reg    mro1_s_M_elems_V_1_blk_n;
wire    ap_block_pp0_stage0_grp3;
reg    mro1_s_M_elems_V_0_blk_n;
wire    ap_block_pp0_stage0_grp1;
reg    mro1_s_M_elems_V_4_blk_n;
reg    mro1_s_M_elems_V_5_blk_n;
reg    mro1_s_M_elems_V_6_blk_n;
reg    mro1_s_M_elems_V_7_blk_n;
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = (((trunc_ln159_reg_229 == 1'd1) & (mro1_s_M_elems_V_4_full_n == 1'b0)) | ((trunc_ln159_reg_229 == 1'd0) & (mro1_s_M_elems_V_0_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp3 = (((trunc_ln159_reg_229 == 1'd1) & (mro1_s_M_elems_V_5_full_n == 1'b0)) | ((trunc_ln159_reg_229 == 1'd0) & (mro1_s_M_elems_V_1_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp5 = (((trunc_ln159_reg_229 == 1'd1) & (mro1_s_M_elems_V_6_full_n == 1'b0)) | ((trunc_ln159_reg_229 == 1'd0) & (mro1_s_M_elems_V_2_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp7 = (((mro1_s_M_elems_V_3_full_n == 1'b0) & (icmp_ln160_reg_233 == 1'd1)) | ((mro1_s_M_elems_V_7_full_n == 1'b0) & (icmp_ln160_reg_233 == 1'd0)));
end
...
assign icmp_ln160_fu_184_p2 = ((or_ln160_1_fu_176_p3 == 3'd3) ? 1'b1 : 1'b0);

assign mro1_s_M_elems_V_0_din = empty;

assign mro1_s_M_elems_V_1_din = p_0_0_1719_partselect;

assign mro1_s_M_elems_V_2_din = p_0_0_2720_partselect;

assign mro1_s_M_elems_V_3_din = p_0_0_3721_partselect;

assign mro1_s_M_elems_V_4_din = empty;

assign mro1_s_M_elems_V_5_din = p_0_0_1719_partselect;

assign mro1_s_M_elems_V_6_din = p_0_0_2720_partselect;

assign mro1_s_M_elems_V_7_din = p_0_0_3721_partselect;

assign or_ln160_1_fu_176_p3 = {{trunc_ln159_fu_172_p1}, {2'd3}};

assign trunc_ln159_fu_172_p1 = ap_sig_allocacmp_j[0:0];

endmodule //Macro_MAC_Acc4_top_Loop_VITIS_LOOP_324_2_proc_Pipeline_VITIS_LOOP_154_22
