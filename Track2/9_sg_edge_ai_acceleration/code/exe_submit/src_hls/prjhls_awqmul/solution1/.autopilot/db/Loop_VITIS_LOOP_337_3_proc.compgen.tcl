...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_out_r \
    op interface \
    ports { out_r { O 128 vector } out_r_ap_vld { O 1 bit } } \
} "
}
...
set InstName Macro_MAC_Acc4_top_flow_control_loop_pipe_U
set CompName Macro_MAC_Acc4_top_flow_control_loop_pipe
