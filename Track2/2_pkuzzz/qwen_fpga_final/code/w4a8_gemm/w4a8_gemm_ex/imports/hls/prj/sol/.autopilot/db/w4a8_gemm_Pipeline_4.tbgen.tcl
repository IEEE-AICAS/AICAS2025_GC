set moduleName w4a8_gemm_Pipeline_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {w4a8_gemm_Pipeline_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ m01_axi int 512 regular {axi_master 0}  }
	{ sext_ln82 int 58 regular  }
	{ m01_axi_input_buffer int 32 regular {array 8192 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m01_axi", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "axi01_ptr0","offset": { "type": "dynamic","port_name": "axi01_ptr0","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln82", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "m01_axi_input_buffer", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ m_axi_m01_axi_AWVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_AWREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_AWADDR sc_out sc_lv 64 signal 0 } 
	{ m_axi_m01_axi_AWID sc_out sc_lv 1 signal 0 } 
	{ m_axi_m01_axi_AWLEN sc_out sc_lv 32 signal 0 } 
	{ m_axi_m01_axi_AWSIZE sc_out sc_lv 3 signal 0 } 
	{ m_axi_m01_axi_AWBURST sc_out sc_lv 2 signal 0 } 
	{ m_axi_m01_axi_AWLOCK sc_out sc_lv 2 signal 0 } 
	{ m_axi_m01_axi_AWCACHE sc_out sc_lv 4 signal 0 } 
	{ m_axi_m01_axi_AWPROT sc_out sc_lv 3 signal 0 } 
	{ m_axi_m01_axi_AWQOS sc_out sc_lv 4 signal 0 } 
	{ m_axi_m01_axi_AWREGION sc_out sc_lv 4 signal 0 } 
	{ m_axi_m01_axi_AWUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_m01_axi_WVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_WREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_WDATA sc_out sc_lv 512 signal 0 } 
	{ m_axi_m01_axi_WSTRB sc_out sc_lv 64 signal 0 } 
	{ m_axi_m01_axi_WLAST sc_out sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_WID sc_out sc_lv 1 signal 0 } 
	{ m_axi_m01_axi_WUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_m01_axi_ARVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_ARREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_ARADDR sc_out sc_lv 64 signal 0 } 
	{ m_axi_m01_axi_ARID sc_out sc_lv 1 signal 0 } 
	{ m_axi_m01_axi_ARLEN sc_out sc_lv 32 signal 0 } 
	{ m_axi_m01_axi_ARSIZE sc_out sc_lv 3 signal 0 } 
	{ m_axi_m01_axi_ARBURST sc_out sc_lv 2 signal 0 } 
	{ m_axi_m01_axi_ARLOCK sc_out sc_lv 2 signal 0 } 
	{ m_axi_m01_axi_ARCACHE sc_out sc_lv 4 signal 0 } 
	{ m_axi_m01_axi_ARPROT sc_out sc_lv 3 signal 0 } 
	{ m_axi_m01_axi_ARQOS sc_out sc_lv 4 signal 0 } 
	{ m_axi_m01_axi_ARREGION sc_out sc_lv 4 signal 0 } 
	{ m_axi_m01_axi_ARUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_m01_axi_RVALID sc_in sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_RREADY sc_out sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_RDATA sc_in sc_lv 512 signal 0 } 
	{ m_axi_m01_axi_RLAST sc_in sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_RID sc_in sc_lv 1 signal 0 } 
	{ m_axi_m01_axi_RFIFONUM sc_in sc_lv 9 signal 0 } 
	{ m_axi_m01_axi_RUSER sc_in sc_lv 1 signal 0 } 
	{ m_axi_m01_axi_RRESP sc_in sc_lv 2 signal 0 } 
	{ m_axi_m01_axi_BVALID sc_in sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_BREADY sc_out sc_logic 1 signal 0 } 
	{ m_axi_m01_axi_BRESP sc_in sc_lv 2 signal 0 } 
	{ m_axi_m01_axi_BID sc_in sc_lv 1 signal 0 } 
	{ m_axi_m01_axi_BUSER sc_in sc_lv 1 signal 0 } 
	{ sext_ln82 sc_in sc_lv 58 signal 1 } 
	{ m01_axi_input_buffer_address0 sc_out sc_lv 13 signal 2 } 
	{ m01_axi_input_buffer_ce0 sc_out sc_logic 1 signal 2 } 
	{ m01_axi_input_buffer_we0 sc_out sc_logic 1 signal 2 } 
	{ m01_axi_input_buffer_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_m01_axi_AWLEN", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "m01_axi", "role": "AWLEN" }} , 
 	...
 	{ "name": "m_axi_m01_axi_ARLEN", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "m01_axi", "role": "ARLEN" }} , 
 	...
 	{ "name": "m_axi_m01_axi_RFIFONUM", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "m01_axi", "role": "RFIFONUM" }} , 
 	...
 	{ "name": "sext_ln82", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln82", "role": "default" }} , 
 	{ "name": "m01_axi_input_buffer_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "m01_axi_input_buffer", "role": "address0" }} , 
 	{ "name": "m01_axi_input_buffer_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "m01_axi_input_buffer", "role": "ce0" }} , 
 	{ "name": "m01_axi_input_buffer_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "m01_axi_input_buffer", "role": "we0" }} , 
 	{ "name": "m01_axi_input_buffer_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "m01_axi_input_buffer", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	 { m_axi {  { m_axi_m01_axi_AWVALID VALID 1 1 }  { m_axi_m01_axi_AWREADY READY 0 1 }  { m_axi_m01_axi_AWADDR ADDR 1 64 }  { m_axi_m01_axi_AWID ID 1 1 }  { m_axi_m01_axi_AWLEN SIZE 1 32 }  { m_axi_m01_axi_AWSIZE BURST 1 3 }  { m_axi_m01_axi_AWBURST LOCK 1 2 }  { m_axi_m01_axi_AWLOCK CACHE 1 2 }  { m_axi_m01_axi_AWCACHE PROT 1 4 }  { m_axi_m01_axi_AWPROT QOS 1 3 }  { m_axi_m01_axi_AWQOS REGION 1 4 }  { m_axi_m01_axi_AWREGION USER 1 4 }  { m_axi_m01_axi_AWUSER DATA 1 1 }  { m_axi_m01_axi_WVALID VALID 1 1 }  { m_axi_m01_axi_WREADY READY 0 1 }  { m_axi_m01_axi_WDATA FIFONUM 1 512 }  { m_axi_m01_axi_WSTRB STRB 1 64 }  { m_axi_m01_axi_WLAST LAST 1 1 }  { m_axi_m01_axi_WID ID 1 1 }  { m_axi_m01_axi_WUSER DATA 1 1 }  { m_axi_m01_axi_ARVALID VALID 1 1 }  { m_axi_m01_axi_ARREADY READY 0 1 }  { m_axi_m01_axi_ARADDR ADDR 1 64 }  { m_axi_m01_axi_ARID ID 1 1 }  { m_axi_m01_axi_ARLEN SIZE 1 32 }  { m_axi_m01_axi_ARSIZE BURST 1 3 }  { m_axi_m01_axi_ARBURST LOCK 1 2 }  { m_axi_m01_axi_ARLOCK CACHE 1 2 }  { m_axi_m01_axi_ARCACHE PROT 1 4 }  { m_axi_m01_axi_ARPROT QOS 1 3 }  { m_axi_m01_axi_ARQOS REGION 1 4 }  { m_axi_m01_axi_ARREGION USER 1 4 }  { m_axi_m01_axi_ARUSER DATA 1 1 }  { m_axi_m01_axi_RVALID VALID 0 1 }  { m_axi_m01_axi_RREADY READY 1 1 }  { m_axi_m01_axi_RDATA FIFONUM 0 512 }  { m_axi_m01_axi_RLAST LAST 0 1 }  { m_axi_m01_axi_RID ID 0 1 }  { m_axi_m01_axi_RFIFONUM LEN 0 9 }  { m_axi_m01_axi_RUSER DATA 0 1 }  { m_axi_m01_axi_RRESP RESP 0 2 }  { m_axi_m01_axi_BVALID VALID 0 1 }  { m_axi_m01_axi_BREADY READY 1 1 }  { m_axi_m01_axi_BRESP RESP 0 2 }  { m_axi_m01_axi_BID ID 0 1 }  { m_axi_m01_axi_BUSER DATA 0 1 } } }
	sext_ln82 { ap_none {  { sext_ln82 in_data 0 58 } } }
	m01_axi_input_buffer { ap_memory {  { m01_axi_input_buffer_address0 mem_address 1 13 }  { m01_axi_input_buffer_ce0 mem_ce 1 1 }  { m01_axi_input_buffer_we0 mem_we 1 1 }  { m01_axi_input_buffer_d0 mem_din 1 32 } } }
}
