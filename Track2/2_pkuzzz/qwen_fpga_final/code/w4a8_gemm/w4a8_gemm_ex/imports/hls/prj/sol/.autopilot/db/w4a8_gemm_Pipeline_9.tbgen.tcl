set moduleName w4a8_gemm_Pipeline_9
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {w4a8_gemm_Pipeline_9}
set C_modelType { void 0 }
set C_modelArgList {
	{ m02_axi int 512 regular {axi_master 1}  }
	{ sext_ln103 int 58 regular  }
	{ m02_axi_output_buffer int 32 regular {array 8192 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m02_axi", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "axi02_ptr0","offset": { "type": "dynamic","port_name": "axi02_ptr0","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln103", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "m02_axi_output_buffer", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln103 sc_in sc_lv 58 signal 1 } 
	{ m02_axi_output_buffer_address0 sc_out sc_lv 13 signal 2 } 
	{ m02_axi_output_buffer_ce0 sc_out sc_logic 1 signal 2 } 
	{ m02_axi_output_buffer_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln103", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln103", "role": "default" }} , 
 	...
 	{ "name": "m02_axi_output_buffer_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "m02_axi_output_buffer", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln103 { ap_none {  { sext_ln103 in_data 0 58 } } }
	m02_axi_output_buffer { ap_memory {  { m02_axi_output_buffer_address0 mem_address 1 13 }  { m02_axi_output_buffer_ce0 mem_ce 1 1 }  { m02_axi_output_buffer_q0 mem_dout 0 32 } } }
}
