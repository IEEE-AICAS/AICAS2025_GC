...
entity w4a8_gemm_w4a8_gemm_Pipeline_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln61 : IN STD_LOGIC_VECTOR (57 downto 0);
...
architecture behav of w4a8_gemm_w4a8_gemm_Pipeline_1 is 
...
attribute shreg_extract : string;
    ...
    signal exitcond3017_reg_205 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_57_reg_209 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_predicate_op25_read_state2 : BOOLEAN;
    signal ap_block_state2_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state3_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal exitcond3017_fu_116_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal loop_index15_load_reg_200 : STD_LOGIC_VECTOR (12 downto 0);
    signal loop_index15_load_reg_200_pp0_iter1_reg : STD_LOGIC_VECTOR (12 downto 0);
    signal exitcond3017_reg_205_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_57_fu_132_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_57_reg_209_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal m00_axi_addr_read_reg_213 : STD_LOGIC_VECTOR (511 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal ap_phi_mux_empty_54_phi_fu_93_p4 : STD_LOGIC_VECTOR (511 downto 0);
    signal ap_phi_reg_pp0_iter2_empty_54_reg_90 : STD_LOGIC_VECTOR (511 downto 0);
    signal shiftreg43_cast_fu_152_p1 : STD_LOGIC_VECTOR (511 downto 0);
    signal loop_index15_cast6_fu_157_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal shiftreg43_fu_58 : STD_LOGIC_VECTOR (479 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal loop_index15_fu_62 : STD_LOGIC_VECTOR (12 downto 0);
    signal empty_53_fu_122_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_sig_allocacmp_loop_index15_load : STD_LOGIC_VECTOR (12 downto 0);
    signal empty_56_fu_128_p1 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    loop_index15_fu_62_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (exitcond3017_fu_116_p2 = ap_const_lv1_0))) then 
                    loop_index15_fu_62 <= empty_53_fu_122_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index15_fu_62 <= ap_const_lv13_0;
                end if;
            end if; 
        end if;
    end process;

    shiftreg43_fu_58_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    shiftreg43_fu_58 <= ap_const_lv480_lc_1;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    shiftreg43_fu_58 <= ap_phi_mux_empty_54_phi_fu_93_p4(511 downto 32);
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                empty_57_reg_209_pp0_iter1_reg <= empty_57_reg_209;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond3017_fu_116_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                empty_57_reg_209 <= empty_57_fu_132_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond3017_fu_116_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond3017_fu_116_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond3017_reg_205, ap_block_pp0_stage0_subdone)
    begin
        if (((exitcond3017_reg_205 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_phi_mux_empty_54_phi_fu_93_p4_assign_proc : process(exitcond3017_reg_205_pp0_iter1_reg, empty_57_reg_209_pp0_iter1_reg, m00_axi_addr_read_reg_213, ap_phi_reg_pp0_iter2_empty_54_reg_90, shiftreg43_cast_fu_152_p1)
    begin
        if ((exitcond3017_reg_205_pp0_iter1_reg = ap_const_lv1_0)) then
            if ((empty_57_reg_209_pp0_iter1_reg = ap_const_lv1_0)) then 
                ap_phi_mux_empty_54_phi_fu_93_p4 <= shiftreg43_cast_fu_152_p1;
            elsif ((empty_57_reg_209_pp0_iter1_reg = ap_const_lv1_1)) then 
                ap_phi_mux_empty_54_phi_fu_93_p4 <= m00_axi_addr_read_reg_213;
            else 
                ap_phi_mux_empty_54_phi_fu_93_p4 <= ap_phi_reg_pp0_iter2_empty_54_reg_90;
            end if;
        else 
            ap_phi_mux_empty_54_phi_fu_93_p4 <= ap_phi_reg_pp0_iter2_empty_54_reg_90;
        end if; 
    ...
    ap_phi_reg_pp0_iter2_empty_54_reg_90 <= "";

    ap_predicate_op25_read_state2_assign_proc : process(exitcond3017_reg_205, empty_57_reg_209)
    begin
                ap_predicate_op25_read_state2 <= ((empty_57_reg_209 = ap_const_lv1_1) and (exitcond3017_reg_205 = ap_const_lv1_0));
    end process;
    ...
    ap_sig_allocacmp_loop_index15_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, loop_index15_fu_62)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_sig_allocacmp_loop_index15_load <= ap_const_lv13_0;
        else 
            ap_sig_allocacmp_loop_index15_load <= loop_index15_fu_62;
        end if; 
    end process;

    empty_53_fu_122_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index15_load) + unsigned(ap_const_lv13_1));
    empty_56_fu_128_p1 <= ap_sig_allocacmp_loop_index15_load(4 - 1 downto 0);
    empty_57_fu_132_p2 <= "1" when (empty_56_fu_128_p1 = ap_const_lv4_0) else "0";
    exitcond3017_fu_116_p2 <= "1" when (ap_sig_allocacmp_loop_index15_load = ap_const_lv13_1000) else "0";
    loop_index15_cast6_fu_157_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(loop_index15_load_reg_200_pp0_iter1_reg),64));
    ...
    m00_axi_input_buffer_address0 <= loop_index15_cast6_fu_157_p1(13 - 1 downto 0);
    ...
    m00_axi_input_buffer_d0 <= ap_phi_mux_empty_54_phi_fu_93_p4(32 - 1 downto 0);
    ...
    shiftreg43_cast_fu_152_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shiftreg43_fu_58),512));
end behav;
