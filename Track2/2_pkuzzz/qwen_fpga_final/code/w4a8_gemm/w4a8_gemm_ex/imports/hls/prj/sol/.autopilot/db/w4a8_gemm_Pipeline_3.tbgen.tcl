set moduleName w4a8_gemm_Pipeline_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {w4a8_gemm_Pipeline_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ m00_axi int 512 regular {axi_master 1}  }
	{ sext_ln61 int 58 regular  }
	{ m00_axi_output_buffer int 32 regular {array 8192 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m00_axi", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "axi00_ptr0","offset": { "type": "dynamic","port_name": "axi00_ptr0","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln61", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "m00_axi_output_buffer", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ m_axi_m00_axi_RFIFONUM sc_in sc_lv 9 signal 0 } 
	...
	{ sext_ln61 sc_in sc_lv 58 signal 1 } 
	{ m00_axi_output_buffer_address0 sc_out sc_lv 13 signal 2 } 
	{ m00_axi_output_buffer_ce0 sc_out sc_logic 1 signal 2 } 
	{ m00_axi_output_buffer_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_m00_axi_RFIFONUM", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "m00_axi", "role": "RFIFONUM" }} , 
 	...
 	{ "name": "sext_ln61", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln61", "role": "default" }} , 
 	{ "name": "m00_axi_output_buffer_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "m00_axi_output_buffer", "role": "address0" }} , 
 	{ "name": "m00_axi_output_buffer_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "m00_axi_output_buffer", "role": "ce0" }} , 
 	{ "name": "m00_axi_output_buffer_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "m00_axi_output_buffer", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	 { m_axi {  { m_axi_m00_axi_AWVALID VALID 1 1 }  { m_axi_m00_axi_AWREADY READY 0 1 }  { m_axi_m00_axi_AWADDR ADDR 1 64 }  { m_axi_m00_axi_AWID ID 1 1 }  { m_axi_m00_axi_AWLEN SIZE 1 32 }  { m_axi_m00_axi_AWSIZE BURST 1 3 }  { m_axi_m00_axi_AWBURST LOCK 1 2 }  { m_axi_m00_axi_AWLOCK CACHE 1 2 }  { m_axi_m00_axi_AWCACHE PROT 1 4 }  { m_axi_m00_axi_AWPROT QOS 1 3 }  { m_axi_m00_axi_AWQOS REGION 1 4 }  { m_axi_m00_axi_AWREGION USER 1 4 }  { m_axi_m00_axi_AWUSER DATA 1 1 }  { m_axi_m00_axi_WVALID VALID 1 1 }  { m_axi_m00_axi_WREADY READY 0 1 }  { m_axi_m00_axi_WDATA FIFONUM 1 512 }  { m_axi_m00_axi_WSTRB STRB 1 64 }  { m_axi_m00_axi_WLAST LAST 1 1 }  { m_axi_m00_axi_WID ID 1 1 }  { m_axi_m00_axi_WUSER DATA 1 1 }  { m_axi_m00_axi_ARVALID VALID 1 1 }  { m_axi_m00_axi_ARREADY READY 0 1 }  { m_axi_m00_axi_ARADDR ADDR 1 64 }  { m_axi_m00_axi_ARID ID 1 1 }  { m_axi_m00_axi_ARLEN SIZE 1 32 }  { m_axi_m00_axi_ARSIZE BURST 1 3 }  { m_axi_m00_axi_ARBURST LOCK 1 2 }  { m_axi_m00_axi_ARLOCK CACHE 1 2 }  { m_axi_m00_axi_ARCACHE PROT 1 4 }  { m_axi_m00_axi_ARPROT QOS 1 3 }  { m_axi_m00_axi_ARQOS REGION 1 4 }  { m_axi_m00_axi_ARREGION USER 1 4 }  { m_axi_m00_axi_ARUSER DATA 1 1 }  { m_axi_m00_axi_RVALID VALID 0 1 }  { m_axi_m00_axi_RREADY READY 1 1 }  { m_axi_m00_axi_RDATA FIFONUM 0 512 }  { m_axi_m00_axi_RLAST LAST 0 1 }  { m_axi_m00_axi_RID ID 0 1 }  { m_axi_m00_axi_RFIFONUM LEN 0 9 }  { m_axi_m00_axi_RUSER DATA 0 1 }  { m_axi_m00_axi_RRESP RESP 0 2 }  { m_axi_m00_axi_BVALID VALID 0 1 }  { m_axi_m00_axi_BREADY READY 1 1 }  { m_axi_m00_axi_BRESP RESP 0 2 }  { m_axi_m00_axi_BID ID 0 1 }  { m_axi_m00_axi_BUSER DATA 0 1 } } }
	sext_ln61 { ap_none {  { sext_ln61 in_data 0 58 } } }
	m00_axi_output_buffer { ap_memory {  { m00_axi_output_buffer_address0 mem_address 1 13 }  { m00_axi_output_buffer_ce0 mem_ce 1 1 }  { m00_axi_output_buffer_q0 mem_dout 0 32 } } }
}
