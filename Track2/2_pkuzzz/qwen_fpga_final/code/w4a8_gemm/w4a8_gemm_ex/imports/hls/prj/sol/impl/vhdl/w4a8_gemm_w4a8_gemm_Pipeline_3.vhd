...
entity w4a8_gemm_w4a8_gemm_Pipeline_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of w4a8_gemm_w4a8_gemm_Pipeline_3 is 
...
attribute shreg_extract : string;
    ...
    signal empty_52_reg_225 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_52_reg_225_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state3_io : BOOLEAN;
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal exitcond2615_fu_116_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal exitcond2615_reg_216 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_52_fu_137_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal m00_axi_output_buffer_load_reg_235 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal loop_index12_cast7_fu_128_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal shiftreg41_fu_64 : STD_LOGIC_VECTOR (479 downto 0);
    signal empty_50_fu_184_p3 : STD_LOGIC_VECTOR (479 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal loop_index12_fu_68 : STD_LOGIC_VECTOR (12 downto 0);
    signal empty_49_fu_122_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_sig_allocacmp_loop_index12_load : STD_LOGIC_VECTOR (12 downto 0);
    signal empty_51_fu_133_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_3_fu_167_p4 : STD_LOGIC_VECTOR (447 downto 0);
    signal tmp_4_fu_177_p3 : STD_LOGIC_VECTOR (479 downto 0);
...
begin
    ...
    loop_index12_fu_68_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (exitcond2615_fu_116_p2 = ap_const_lv1_0))) then 
                    loop_index12_fu_68 <= empty_49_fu_122_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index12_fu_68 <= ap_const_lv13_0;
                end if;
            end if; 
        end if;
    end process;

    shiftreg41_fu_64_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    shiftreg41_fu_64 <= ap_const_lv480_lc_1;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    shiftreg41_fu_64 <= empty_50_fu_184_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                empty_52_reg_225_pp0_iter1_reg <= empty_52_reg_225;
                exitcond2615_reg_216 <= exitcond2615_fu_116_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond2615_fu_116_p2 = ap_const_lv1_0))) then
                empty_52_reg_225 <= empty_52_fu_137_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond2615_reg_216 = ap_const_lv1_0))) then
    ...
    ap_block_state3_io_assign_proc : process(m_axi_m00_axi_WREADY, empty_52_reg_225_pp0_iter1_reg)
    begin
                ap_block_state3_io <= ((empty_52_reg_225_pp0_iter1_reg = ap_const_lv1_1) and (m_axi_m00_axi_WREADY = ap_const_logic_0));
    end process;

        ap_block_state3_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond2615_fu_116_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond2615_fu_116_p2 = ap_const_lv1_1))) then 
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, exitcond2615_reg_216)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond2615_reg_216 = ap_const_lv1_1))) then 
    ...
    ap_sig_allocacmp_loop_index12_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, loop_index12_fu_68)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_loop_index12_load <= ap_const_lv13_0;
        else 
            ap_sig_allocacmp_loop_index12_load <= loop_index12_fu_68;
        end if; 
    end process;

    empty_49_fu_122_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index12_load) + unsigned(ap_const_lv13_1));
    empty_50_fu_184_p3 <= 
        ap_const_lv480_lc_1 when (empty_52_reg_225_pp0_iter1_reg(0) = '1') else 
        tmp_4_fu_177_p3;
    empty_51_fu_133_p1 <= ap_sig_allocacmp_loop_index12_load(4 - 1 downto 0);
    empty_52_fu_137_p2 <= "1" when (empty_51_fu_133_p1 = ap_const_lv4_F) else "0";
    exitcond2615_fu_116_p2 <= "1" when (ap_sig_allocacmp_loop_index12_load = ap_const_lv13_1000) else "0";
    loop_index12_cast7_fu_128_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_loop_index12_load),64));

    m00_axi_blk_n_W_assign_proc : process(ap_enable_reg_pp0_iter2, m_axi_m00_axi_WREADY, empty_52_reg_225_pp0_iter1_reg, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (empty_52_reg_225_pp0_iter1_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    m00_axi_output_buffer_address0 <= loop_index12_cast7_fu_128_p1(13 - 1 downto 0);

    m00_axi_output_buffer_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
    ...
    m_axi_m00_axi_WDATA <= (m00_axi_output_buffer_load_reg_235 & shiftreg41_fu_64);
    m_axi_m00_axi_WID <= ap_const_lv1_0;
    m_axi_m00_axi_WLAST <= ap_const_logic_0;
    m_axi_m00_axi_WSTRB <= ap_const_lv64_FFFFFFFFFFFFFFFF;
    m_axi_m00_axi_WUSER <= ap_const_lv1_0;

    m_axi_m00_axi_WVALID_assign_proc : process(ap_enable_reg_pp0_iter2, empty_52_reg_225_pp0_iter1_reg, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (empty_52_reg_225_pp0_iter1_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            m_axi_m00_axi_WVALID <= ap_const_logic_1;
        else 
            m_axi_m00_axi_WVALID <= ap_const_logic_0;
        end if; 
    end process;

    tmp_3_fu_167_p4 <= shiftreg41_fu_64(479 downto 32);
    tmp_4_fu_177_p3 <= (m00_axi_output_buffer_load_reg_235 & tmp_3_fu_167_p4);
end behav;
