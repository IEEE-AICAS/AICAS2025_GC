...
module w4a8_gemm_w4a8_gemm_Pipeline_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] empty_39_fu_132_p2;
reg   [0:0] empty_39_reg_209_pp0_iter1_reg;
reg   [511:0] m02_axi_addr_read_reg_213;
reg    ap_condition_exit_pp0_iter1_stage0;
reg   [511:0] ap_phi_mux_empty_36_phi_fu_93_p4;
wire   [511:0] ap_phi_reg_pp0_iter2_empty_36_reg_90;
...
wire   [12:0] empty_35_fu_122_p2;
reg   [12:0] ap_sig_allocacmp_loop_index3_load;
wire   [3:0] empty_38_fu_128_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            shiftreg35_fu_58 <= {{ap_phi_mux_empty_36_phi_fu_93_p4[511:32]}};
        end
    end
end
...
always @ (*) begin
    if ((exitcond2011_reg_205_pp0_iter1_reg == 1'd0)) begin
        if ((empty_39_reg_209_pp0_iter1_reg == 1'd0)) begin
            ap_phi_mux_empty_36_phi_fu_93_p4 = shiftreg35_cast_fu_152_p1;
        end else if ((empty_39_reg_209_pp0_iter1_reg == 1'd1)) begin
...
assign ap_phi_reg_pp0_iter2_empty_36_reg_90 = 'bx;

always @ (*) begin
    ap_predicate_op25_read_state2 = ((empty_39_reg_209 == 1'd1) & (exitcond2011_reg_205 == 1'd0));
end

assign empty_35_fu_122_p2 = (ap_sig_allocacmp_loop_index3_load + 13'd1);

assign empty_38_fu_128_p1 = ap_sig_allocacmp_loop_index3_load[3:0];

assign empty_39_fu_132_p2 = ((empty_38_fu_128_p1 == 4'd0) ? 1'b1 : 1'b0);
...
assign m02_axi_input_buffer_d0 = ap_phi_mux_empty_36_phi_fu_93_p4[31:0];
...
endmodule //w4a8_gemm_w4a8_gemm_Pipeline_7
