...
module w4a8_gemm_w4a8_gemm_Pipeline_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] empty_52_reg_225;
reg   [0:0] empty_52_reg_225_pp0_iter1_reg;
reg    ap_block_state3_io;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] exitcond2615_fu_116_p2;
...
reg   [0:0] exitcond2615_reg_216;
wire   [0:0] empty_52_fu_137_p2;
reg   [31:0] m00_axi_output_buffer_load_reg_235;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] loop_index12_cast7_fu_128_p1;
wire    ap_block_pp0_stage0_01001;
reg   [479:0] shiftreg41_fu_64;
wire   [479:0] empty_50_fu_184_p3;
wire    ap_loop_init;
reg   [12:0] loop_index12_fu_68;
wire   [12:0] empty_49_fu_122_p2;
reg   [12:0] ap_sig_allocacmp_loop_index12_load;
wire   [3:0] empty_51_fu_133_p1;
wire   [447:0] tmp_3_fu_167_p4;
wire   [479:0] tmp_4_fu_177_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond2615_fu_116_p2 == 1'd0))) begin
            loop_index12_fu_68 <= empty_49_fu_122_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index12_fu_68 <= 13'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond2615_fu_116_p2 == 1'd0))) begin
        empty_52_reg_225 <= empty_52_fu_137_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond2615_reg_216 == 1'd0))) begin
        m00_axi_output_buffer_load_reg_235 <= m00_axi_output_buffer_q0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond2615_fu_116_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond2615_reg_216 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_loop_index12_load = 13'd0;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (empty_52_reg_225_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (empty_52_reg_225_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    ap_block_state3_io = ((empty_52_reg_225_pp0_iter1_reg == 1'd1) & (m_axi_m00_axi_WREADY == 1'b0));
end
...
assign empty_49_fu_122_p2 = (ap_sig_allocacmp_loop_index12_load + 13'd1);

assign empty_50_fu_184_p3 = ((empty_52_reg_225_pp0_iter1_reg[0:0] == 1'b1) ? 480'd0 : tmp_4_fu_177_p3);

assign empty_51_fu_133_p1 = ap_sig_allocacmp_loop_index12_load[3:0];

assign empty_52_fu_137_p2 = ((empty_51_fu_133_p1 == 4'd15) ? 1'b1 : 1'b0);

assign exitcond2615_fu_116_p2 = ((ap_sig_allocacmp_loop_index12_load == 13'd4096) ? 1'b1 : 1'b0);

assign loop_index12_cast7_fu_128_p1 = ap_sig_allocacmp_loop_index12_load;

assign m00_axi_output_buffer_address0 = loop_index12_cast7_fu_128_p1;
...
assign m_axi_m00_axi_WDATA = {{m00_axi_output_buffer_load_reg_235}, {shiftreg41_fu_64}};
...
assign tmp_3_fu_167_p4 = {{shiftreg41_fu_64[479:32]}};

assign tmp_4_fu_177_p3 = {{m00_axi_output_buffer_load_reg_235}, {tmp_3_fu_167_p4}};

endmodule //w4a8_gemm_w4a8_gemm_Pipeline_3
