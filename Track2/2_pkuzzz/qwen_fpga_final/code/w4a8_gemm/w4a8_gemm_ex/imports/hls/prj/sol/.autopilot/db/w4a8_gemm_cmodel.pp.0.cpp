...
# 2 "<built-in>" 2
# 1 "../w4a8_gemm_cmodel.cpp" 2
# 17 "../w4a8_gemm_cmodel.cpp"
...
# 21 "../w4a8_gemm_cmodel.cpp" 2





extern "C" __attribute__((sdx_kernel("w4a8_gemm", 0))) void w4a8_gemm (
...
#line 9 "/home/xiping/workspace/kv260_rtl_kernel_test_vitis/rtl_kernel_test_100M_kernels/vivado_rtl_kernel/w4a8_gemm_ex/imports/hls/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=w4a8_gemm
# 34 "../w4a8_gemm_cmodel.cpp"
...
#pragma HLS INTERFACE ap_ctrl_hs port=return
 ...
 int m00_axi_input_buffer[8192];
    int m00_axi_output_buffer[8192];
    ...
    VITIS_LOOP_64_1: for (unsigned int i = 0; i < m00_axi_length; i++) {
    ...
    int m01_axi_input_buffer[8192];
    int m01_axi_output_buffer[8192];
    ...
    VITIS_LOOP_85_2: for (unsigned int i = 0; i < m01_axi_length; i++) {
    ...
    int m02_axi_input_buffer[8192];
    int m02_axi_output_buffer[8192];
    ...
    VITIS_LOOP_106_3: for (unsigned int i = 0; i < m02_axi_length; i++) {
