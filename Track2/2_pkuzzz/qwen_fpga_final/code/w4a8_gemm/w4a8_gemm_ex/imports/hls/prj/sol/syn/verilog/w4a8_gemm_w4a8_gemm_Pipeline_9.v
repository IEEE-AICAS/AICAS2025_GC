...
module w4a8_gemm_w4a8_gemm_Pipeline_9 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] empty_34_reg_225;
reg   [0:0] empty_34_reg_225_pp0_iter1_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (empty_34_reg_225_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (empty_34_reg_225_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    ap_block_state3_io = ((empty_34_reg_225_pp0_iter1_reg == 1'd1) & (m_axi_m02_axi_WREADY == 1'b0));
end
...
assign empty_31_fu_122_p2 = (ap_sig_allocacmp_loop_index_load + 13'd1);

assign empty_32_fu_184_p3 = ((empty_34_reg_225_pp0_iter1_reg[0:0] == 1'b1) ? 480'd0 : tmp_8_fu_177_p3);

assign empty_33_fu_133_p1 = ap_sig_allocacmp_loop_index_load[3:0];

assign empty_34_fu_137_p2 = ((empty_33_fu_133_p1 == 4'd15) ? 1'b1 : 1'b0);
...
endmodule //w4a8_gemm_w4a8_gemm_Pipeline_9
