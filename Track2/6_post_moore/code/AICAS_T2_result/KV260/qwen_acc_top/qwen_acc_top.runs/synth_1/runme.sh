...
HD_PWD='E:/Desktop/LLM/competition/FPGA_GC/KV260/qwen_acc_top/qwen_acc_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accelerate_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accelerate_wrapper.tcl
