...
HD_PWD='E:/Desktop/LLM/competition/FPGA_GC/KV260/qwen_acc_top/qwen_acc_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log accelerate_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source accelerate_wrapper.tcl -notrace
