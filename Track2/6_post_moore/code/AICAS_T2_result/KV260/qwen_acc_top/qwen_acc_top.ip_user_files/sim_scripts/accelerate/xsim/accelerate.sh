...
# set xvlog options
xvlog_opts="--relax  -L uvm -L axi_vip_v1_1_15 -L smartconnect_v1_0 -L zynq_ultra_ps_e_vip_v1_0_15 -L xilinx_vip"
...
elaborate()
{
  xelab --debug typical --relax --mt 2  -L xilinx_vip -L xpm -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_11 -L xlconcat_v2_1_5 -L gigantic_mux -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot accelerate xil_defaultlib.accelerate xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim accelerate -key {Behavioral:sim_1:Functional:accelerate} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5d28.protoinst" -protoinst "protoinst_files/bd_591a.protoinst" -protoinst "protoinst_files/accelerate.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb accelerate.wdb xsim.dir libdpi.so)
