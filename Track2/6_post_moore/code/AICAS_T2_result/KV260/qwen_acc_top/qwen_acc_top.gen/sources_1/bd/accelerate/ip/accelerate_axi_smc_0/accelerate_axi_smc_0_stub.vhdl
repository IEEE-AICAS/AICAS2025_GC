...
-- Date        : Thu Mar 20 23:00:47 2025
-- Host        : DESKTOP-66QCD9K running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top accelerate_axi_smc_0 -prefix
--               accelerate_axi_smc_0_ accelerate_axi_smc_0_stub.vhdl
-- Design      : accelerate_axi_smc_0
...
entity accelerate_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
...
end accelerate_axi_smc_0;

architecture stub of accelerate_axi_smc_0 is
...
attribute X_CORE_INFO of stub : architecture is "bd_5d28,Vivado 2023.2";
begin
end;
