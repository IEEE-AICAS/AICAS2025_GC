...
user.org:user:config_register:1.0\
...
\
  ...
  # Create instance: config_register_0, and set properties
  set config_register_0 [ create_bd_cell -type ip -vlnv user.org:user:config_register:1.0 config_register_0 ]
  ...
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins axi_cdma_0/M_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins config_register_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axi_interconnect_1/M01_AXI] [get_bd_intf_pins axi_bram_ctrl_1/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_1_M02_AXI [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD] [get_bd_intf_pins axi_interconnect_1/M02_AXI]

  # Create port connections
  connect_bd_net -net ARESETN_1  [get_bd_pins rst_ps8_0_99M/interconnect_aresetn] \
  [get_bd_pins axi_interconnect_0/ARESETN] \
  [get_bd_pins axi_interconnect_1/ARESETN]
  connect_bd_net -net Top_0_io_ddr_dataRead  [get_bd_pins Top_0/io_ddr_dataRead] \
  [get_bd_pins axi_bram_ctrl_0/bram_rddata_a]
  connect_bd_net -net Top_0_io_fromCPU_ready  [get_bd_pins Top_0/io_fromCPU_ready] \
  [get_bd_pins config_register_0/from_cpu_ready]
  connect_bd_net -net Top_0_io_kvCache_dataRead  [get_bd_pins Top_0/io_kvCache_dataRead] \
  [get_bd_pins axi_bram_ctrl_1/bram_rddata_a]
  connect_bd_net -net Top_0_io_toCPU_bits  [get_bd_pins Top_0/io_toCPU_bits] \
  [get_bd_pins config_register_0/to_cpu_bits]
  connect_bd_net -net Top_0_io_toCPU_valid  [get_bd_pins Top_0/io_toCPU_valid] \
  [get_bd_pins config_register_0/to_cpu_valid]
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a  [get_bd_pins axi_bram_ctrl_0/bram_addr_a] \
  [get_bd_pins Top_0/io_ddr_addr]
  connect_bd_net -net axi_bram_ctrl_0_bram_clk_a  [get_bd_pins axi_bram_ctrl_0/bram_clk_a] \
  [get_bd_pins Top_0/clock] \
  [get_bd_pins Top_0/io_clk]
  connect_bd_net -net axi_bram_ctrl_0_bram_en_a  [get_bd_pins axi_bram_ctrl_0/bram_en_a] \
  [get_bd_pins Top_0/io_ddr_en]
  connect_bd_net -net axi_bram_ctrl_0_bram_rst_a  [get_bd_pins axi_bram_ctrl_0/bram_rst_a] \
  [get_bd_pins Top_0/reset] \
  [get_bd_pins Top_0/io_rst]
  connect_bd_net -net axi_bram_ctrl_0_bram_we_a  [get_bd_pins axi_bram_ctrl_0/bram_we_a] \
  [get_bd_pins Top_0/io_ddr_writeEn]
  connect_bd_net -net axi_bram_ctrl_0_bram_wrdata_a  [get_bd_pins axi_bram_ctrl_0/bram_wrdata_a] \
  [get_bd_pins Top_0/io_ddr_dataWrite]
  connect_bd_net -net axi_bram_ctrl_1_bram_addr_a  [get_bd_pins axi_bram_ctrl_1/bram_addr_a] \
  [get_bd_pins Top_0/io_kvCache_addr]
  connect_bd_net -net axi_bram_ctrl_1_bram_en_a  [get_bd_pins axi_bram_ctrl_1/bram_en_a] \
  [get_bd_pins Top_0/io_kvCache_en]
  connect_bd_net -net axi_bram_ctrl_1_bram_we_a  [get_bd_pins axi_bram_ctrl_1/bram_we_a] \
  [get_bd_pins Top_0/io_kvCache_writeEn]
  connect_bd_net -net axi_bram_ctrl_1_bram_wrdata_a  [get_bd_pins axi_bram_ctrl_1/bram_wrdata_a] \
  [get_bd_pins Top_0/io_kvCache_dataWrite]
  connect_bd_net -net config_register_0_from_cpu_bits  [get_bd_pins config_register_0/from_cpu_bits] \
  [get_bd_pins Top_0/io_fromCPU_bits]
  connect_bd_net -net config_register_0_from_cpu_valid  [get_bd_pins config_register_0/from_cpu_valid] \
  [get_bd_pins Top_0/io_fromCPU_valid]
  connect_bd_net -net config_register_0_to_cpu_ready  [get_bd_pins config_register_0/to_cpu_ready] \
  [get_bd_pins Top_0/io_toCPU_ready]
  ...
  [get_bd_pins config_register_0/s00_axi_aresetn] \
  ...
  [get_bd_pins config_register_0/s00_axi_aclk] \
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_cdma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs config_register_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA1000000 -range 0x00800000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0800000 -range 0x00800000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] -force
  ...
  exclude_bd_addr_seg -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI]
